...
class CompressionParams(ParamGroup):
    def __init__(self, parser):
        ...
        # self.color_importance_include = 2.4*1e-6
        # self.color_importance_include = 3.0*1e-6
        ...
        # self.gaussian_importance_include = 1.5*1e-5
        # self.gaussian_importance_include = 1.8*1e-5
        # self.gaussian_importance_include = 2.4*1e-5
        # self.gaussian_importance_include = 3.0*1e-5
        # self.gaussian_importance_include = 4.5*1e-5
        # self.gaussian_importance_include = 6.0*1e-5
